...
import datgadriven.utility.XLSReader;
...
public class Utiltest {
	...
	public static ArrayList<Object[]> getDataFromExcel() {
		...
		try {
			reader= new XLSReader("C:\\Users\\Reddybabu\\eclipse-workspace\\TestNGandDatadrivenlearningbynaveen\\src\\com\\testdata\\From.xlsx");
		} catch (Exception e) {
			e.printStackTrace();
		}
